...
export function buildStatsDashboardModel(
  ...
  return {
    ...
    growthEvents: [
      ...
      { event: 'Resume attempts', count: growthEvents.multiplayer_resume_attempt },
      { event: 'Resume successes', count: growthEvents.multiplayer_resume_success },
      { event: 'Resume failures', count: growthEvents.multiplayer_resume_failure },
      { event: 'Resync started', count: growthEvents.multiplayer_resync_started },
      { event: 'Resync completed', count: growthEvents.multiplayer_resync_completed },
