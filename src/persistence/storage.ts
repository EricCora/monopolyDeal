  ...
  try {
    ...
    return {
      ...
      events: {
        ...
        multiplayer_resume_attempt: parseMetricCount(parsed.events?.multiplayer_resume_attempt),
        multiplayer_resume_success: parseMetricCount(parsed.events?.multiplayer_resume_success),
        multiplayer_resume_failure: parseMetricCount(parsed.events?.multiplayer_resume_failure),
        multiplayer_resync_started: parseMetricCount(parsed.events?.multiplayer_resync_started),
        multiplayer_resync_completed: parseMetricCount(parsed.events?.multiplayer_resync_completed),
