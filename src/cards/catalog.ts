...
const rentMatrix: Partial<Record<PropertyColor, number[]>> = {
  brown: [1, 2],
  light_blue: [1, 2, 3],
  pink: [1, 2, 4],
  orange: [1, 3, 5],
...
const actionCards: CardDefinition[] = [
  ...
  { id: 'rent_color', name: 'Rent', kind: 'action', actionKind: 'rent', value: 1, moneyValue: 1, rentMatrix, quantity: 3 },
  { id: 'rent_railroad_utility', name: 'Rent RR/UT', kind: 'action', actionKind: 'rent_wild', value: 1, moneyValue: 1, rentMatrix: { railroad: rentMatrix.railroad, utility: rentMatrix.utility }, quantity: 2 },
  { id: 'rent_green_dark_blue', name: 'Rent GN/DB', kind: 'action', actionKind: 'rent_wild', value: 1, moneyValue: 1, rentMatrix: { green: rentMatrix.green, dark_blue: rentMatrix.dark_blue }, quantity: 2 },
