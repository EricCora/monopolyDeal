...
| MD-C03 | Disconnect tracking + grace retention | MD-C01, MD-C02 | `pending` | `@unassigned` | `apps/server/src/gameService.ts`, `apps/server/src/index.ts` |
...
| MD-C05 | Auto-reconnect retry/backoff | MD-C02, MD-C03, MD-C04 | `pending` | `@unassigned` | `src/app/useMultiplayerRoom.ts` |
| MD-C06 | Resume handshake + seat rebind | MD-C02, MD-C03, MD-C05 | `pending` | `@unassigned` | `apps/server/src/index.ts`, `apps/server/src/gameService.ts`, `src/network/multiplayerClient.ts` |
| MD-C07 | Authoritative full-state resync | MD-C06, MD-C04 | `pending` | `@unassigned` | `src/app/useMultiplayerRoom.ts`, `apps/server/src/gameService.ts` |
